...
function SheetContentConstrained({
  className,
  children,
  side = "right",
  showCloseButton = true,
  ...
  return (
    <>
      <SheetPrimitive.Overlay
        data-slot="sheet-overlay"
        className={cn(
          "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 absolute inset-0 bg-black/50",
        )}
      />
      <SheetPrimitive.Content
        data-slot="sheet-content"
